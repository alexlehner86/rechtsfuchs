    ...
    return (
        <div>
          ...
          <ul className="infoliste">
            ...
            <li>Warum diese Webseite?<br />
                Ich wollte das React-Redux-Framework testen und gleichzeitig eine sinnvolle Anwendung programmieren. Die Webseite bietet einen vereinfachten Zugang zum österreichischen Bundes- und Landesrecht sowie zur Rechtsprechung, mit Fokus auf das Finanzrecht (über Suchwort-Vorschläge). Die Webseite nutzt die APIs des österreichischen Rechtsinformationssystems des Bundes (<a href="https://www.ris.bka.gv.at/" target="_blank" rel="noopener noreferrer">RIS</a>) zu.</li>
