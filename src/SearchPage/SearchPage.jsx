...
//  The search results are displayed on the right by four different components:
//  SearchResultsBundesrecht, SearchResultsLandesrecht, SearchResultsVfGH
//  and SearchResultsVfGH (depending on the user's selection in the search form)
// ---------------------------------------------------------------------------
